      ...
      <div class="land">
        ...
        <div class="land_bc">
          ...
          <div :class="phones">
            ...
            <input placeholder="密码" v-model="land.code" class="phoneInput " type="password"
...
<!--            <button class="code" @click="getCode">{{isShow?code:'获取验证码'}}</button>-->
          ...
          <button class="subLand" @click="landSub">立即登录</button>
          <div class="toRegister">
            还没有账号？<span style="color: #169bd5;">立即注册</span>
          </div>
          <div class="problem">
...
<script>
    import registerHead from './headRegister'
